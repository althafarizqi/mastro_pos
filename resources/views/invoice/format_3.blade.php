    ...
    <div class="invoice-box">
        <table>
                ...
                <td>
                    <table style="border: 0px solid black; width: 800px;">
                        <tr style="border: 0px solid black;">
                            <td style="border: 0px solid black; width: 10   0px;">
                                <img src="{{asset('img/gme.png')}}" alt="Mastro Logo"
                                    style="max-width: 150px; margin-top: -30px " />
                            </td>
                            <td style="border: 0px solid black; ">
                                <p style="margin-top: -5px; font-size: 24px; font-weight: 900;">CV.GARDA MAS ELEKTRONIKA
                                </p>
                                <p style="margin-top: -25px; font-size: small;">Branggah RT 02/ RW 08 Nyatnyono-Ungaran
                                </p>
                                <p style="margin-top: -15px; font-size: small;">Telp: 085 640 501 393 / 0899 590 9910
                                </p>
                            </td>
            ...
            <tfoot style="border: 1px solid black;">
                ...
                <th
                    style="border-top: 1px solid black; border-left: 1px solid black; max-width: 35px; text-align: right;">
                    <div style="font-size: 14px; font-weight: bold; padding-right: 5px">Jumlah</div>
                    <div style="font-size: 11px; font-weight: normal; padding-right: 5px">DPP</div>
                    <div style="font-size: 11px; font-weight: normal; padding-right: 5px">PPN</div>
                </th>
                <th
                    style="border-top: 1px solid black; border-left: 1px solid black; max-width: 35px; text-align: right;">
                    <div style="font-size: 14px; font-weight: bold; padding-right: 5px">
                        {{formatRupiah($penjualanData->total_harga)}}</div>
                    <div style="font-size: 11px; font-weight: normal; padding-right: 5px">
                        {{formatRupiah($penjualanData->total_harga*100/111)}}</div>
                    <div style="font-size: 11px; font-weight: normal; padding-right: 5px">
                        {{formatRupiah($penjualanData->total_harga*100/111*11/100)}}</div>
                </th>
            </tfoot>
        </table>
        </td>
                    ...
                    <tr style="border: 0px solid black;">
                        <td colspan="2" style="border: 0px solid black; max-width: 50%; text-align: center; ">
                            <table>
                                <tr>
                                    <td
                                        style="border: 2px solid black; max-width: 50%; text-align: center; font-size: 14px; font-weight: bold ">
                                        Transfer BNI: 1179537840 <br />
                                        a/n CV.GARDA MAS ELEKTRONIKA
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td colspan="3"
                            style="border: 0px solid black; max-width: 50%; text-align: center; padding-right: 50px ">
                            Penerima<br><br><br>(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)
                        </td>
