                    ...
                    <table style="border: 0px solid black; width: 800px;">
                        <tr style="border: 0px solid black;">
                            ...
                            <td style="border: 0px solid black; ">
                                <p style="margin-top: -5px; font-size: 26px; font-weight: 900;">CV.GARDA MAS ELEKTRONIKA
                                </p>
                        ...
                        <tr style="border: 0px solid black;">
                            <td colspan="2" style="border: 0px solid black; width: 150px;">
                                <table style="margin-top: -10;">
                                    ...
                                    <tr>
                                        <td>Tanggal</td>
                                        <td>: @if ($cetakTanggal) {{$penjualanData->tanggal}} @endif</td>
                                    </tr>
                                </table>
                            </td>
                ...
                <td>
                    <table style="border: 1px solid black; width: 800px;">
                        ...
                        <tr style="border: 1px solid black;">
                            ...
                            <td style="border-right: 1px solid black;">{{$items->barang->nama}}</td>
                        ...
                        <tfoot style="border: 1px solid black;">
                            <th colspan="3" style="border-top: 1px solid black; max-width: 6px; text-align: left;">
                            ...
                            <th
                                ...
                                <div style="font-size: 14px; font-weight: bold">Jumlah</div>
                                <div style="font-size: 11px; font-weight: normal">DPP</div>
                                <div style="font-size: 11px; font-weight: normal">PPN</div>
                            </th>
                            <th
                                style="border-top: 1px solid black; border-left: 1px solid black; max-width: 35px; text-align: right;">
